                                            ...
                                            @else
                                                <div class="col-md-12" style="float:left">
                                                    @php
                                                        ...
                                                        $tins = $MnuCategory->selectedCategories->topic->where('status',1)->sortbyDesc('row_no')->take(5);
                                                            ...
                                                            <?php
                                                                ...
                                                                if ($tin->$slug_var != "" && Helper::GeneralWebmasterSettings("links_status")) {
                                                                    ...
                                                                    if (trans('backLang.code') != env('DEFAULT_LANGUAGE')) {
                                                                        ...
                                                                        $topic_link_url = route('FrontendTopic', ["section" => $tin1->webmasterSection->name, "id" => $tin->id]);
                                                                    }
                                                                }
                                                            ?>
