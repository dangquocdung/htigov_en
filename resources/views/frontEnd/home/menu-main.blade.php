            ...
            <div class="box-body">
                <div class="card">
                    ...
                    <ul class="nav nav-tabs" role="tablist" style="border-bottom: none">
                            ...
                            {{--<li class = "active">--}}
                                {{--<a href="#lich-lam-viec" data-toggle="tab" title="LLV">--}}
                                    {{--<i class="fa fa-bars" title="Lịch làm việc"></i>  <span class="hidden-xs">LLV</span>--}}
                                {{--</a>--}}
                            {{--</li>--}}
                                    ...
                                    @if ($key == 0) active @endif
                                        ...
                                        @if ($MnuCategory->display == 0)
                                            ...
                                            <table class="table table-striped table-bordered table-responsive table-sm" style="margin-bottom: 5px">
                                                ...
                                                <tbody>
                                                @foreach($MnuCategory->selectedCategories as $topicId)
                                                    <tr>
                                                        <td>
                                                            {{ $loop->iteration }}
                                                        </td>
                                                        <td>
                                                            <?php
                                                                $topic_link = $mmnnuu_link."/topic/".$topicId->topic->id;
                                                            ?>
                                                            <a href="{{ $topic_link }}">
